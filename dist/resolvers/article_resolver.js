...
const article_model_1 = __importDefault(require("../models/article_model"));
const category_model_1 = __importDefault(require("../models/category_model"));
...
exports.resolversArticle = {
    Query: {
        getListArticle: (_, args) => __awaiter(void 0, void 0, void 0, function* () {
            ...
            // end search
            const article = yield article_model_1.default.find((find)).sort(sort).limit(limitItems).skip(skip);
            return article;
        }),
